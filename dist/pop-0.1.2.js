...
Game.prototype.startRound = function(params) {
  return this.currentRound = new Round(params);
};
...
Round = function(params) {
  ...
  for (i = _i = 0, _ref = this.balloonCount; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
    this.balloons.push(new Balloon({
      tense: getRandom(this.tenses)
    }));
  }
};

Round.prototype.setNewInfinitive = function() {
  return this.currentInfinitive = getRandom(game.currentLanguage.verbs).infinitive;
};

Round.prototype.handleCompletion = function() {
  var zap;
  return zap = "zap";
};
...
Quiz.prototype.close = function() {
  return delete game.currentRound.currentQuiz;
};
...
Balloon = function(params) {
  var _i, _results;
  this.tense = params.tense;
  this.inflation = params.inflation || getRandom((function() {
    _results = [];
    for (_i = 35; _i <= 65; _i++){ _results.push(_i); }
    return _results;
  }).apply(this));
  this.inflated = true;
};

Balloon.prototype.startQuiz = function() {
  var quiz;
  quiz = new Quiz({
    tense: this.tense,
  ...
  return game.currentRound.currentQuiz = quiz;
};
...
Balloon.prototype.pop = function() {
  ...
  this.inflated = false;
  return game.currentRound.handleCompletion();
};

Balloon.prototype.drop = function() {
...
var INFLATION_RATE, game, language, _i, _len;
